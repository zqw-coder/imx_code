...
#
# Generated by Vivado on Mon Jun 13 00:01:56 +0800 2022
...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="H:/git_respo/10_4fps_1ch_148_5ddr/FPGA_TEST_PATTERN_10_4fps_4ch_freq1/FPGA_TEST_PATTERN.cache/compile_simlib/activehdl"
  fi
